...
import org.frc4931.robot.subsystems.SubsystemBase;
 ...
 * 
 */
public abstract class AbstractMotor implements Sendable, Requireable {
	private final Subsystem requiredFlag = new SubsystemBase() {
	};
	...
	public static class SpeedControllerType {
		public static final SpeedControllerType TALON = new SpeedControllerType(
				0);
		public static final SpeedControllerType VICTOR = new SpeedControllerType(
				1);
		public static final SpeedControllerType JAGUAR = new SpeedControllerType(
				2);
